...
private:
	...
	/** Amount that the slide is pushed back during pisol fire */
	...
	/** True when moving the pisol slide */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Pistol, meta = (AllowPrivateAccess = "true"))
	bool bMovingSlide;
...
public:
	/** Adds an impulse to the Weapon. 무기를 던지는 동작을 구현. */
	void ThrowWeapon();
	
	FORCEINLINE int32 GetAmmo() const { return Ammo; }
	FORCEINLINE int32 GetMagazineCapacity() const { return MagazineCapacity; }

	/** Called from Character class when firing weapon. 탄약 감소. */
	void DecrementAmmo();
	...
	/** True if Amount of Ammo == MaximumCapacity of Magazine (MagazineCapacity) */
	bool ClipIsFull(); 
