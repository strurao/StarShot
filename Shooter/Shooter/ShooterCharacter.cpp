...
void AShooterCharacter::BeginPlay()
{
	...
	EquippedWeapon->SetCharacter(this); //무기의 주인을 지정한 것과 비슷한 의미
...
void AShooterCharacter::TraceForItems()
{
	if (bShouldTraceForItems)
	{
		...
		if (ItemTraceResult.bBlockingHit)
		{
			...
			const auto TraceHitWeapon = Cast<AWeapon>(TraceHitItem); // 추후에 총이 아닌 다른 아이템을 넣겠다면 이 부분이 바껴야 한다
			if (TraceHitWeapon)
			{
...
void AShooterCharacter::UnHighlightInventorySlot()
{
	...
	HighlightedSlot = -1; // There is no slot being highlighted currently
}
...
void AShooterCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("OneKey", IE_Pressed, this,
		&AShooterCharacter::OneKeyPressed);
	PlayerInputComponent->BindAction("TwoKey", IE_Pressed, this,
		&AShooterCharacter::TwoKeyPressed);
	PlayerInputComponent->BindAction("ThreeKey", IE_Pressed, this,
		&AShooterCharacter::ThreeKeyPressed);
	PlayerInputComponent->BindAction("FourKey", IE_Pressed, this,
		&AShooterCharacter::FourKeyPressed);
	PlayerInputComponent->BindAction("FiveKey", IE_Pressed, this,
